          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 0.0, 0.0),
                child: Text(
                  '¡Encuentra tus clases y contacta con tus profesores!',
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1524660988542-c440de9c0fde?w=512&h=512',
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 0.0, 0.0),
                child: Text(
                  'Selecciona un profesor para ver su información y contactarlo.',
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Plus Jakarta Sans',
                        color: FlutterFlowTheme.of(context).secondaryText,
                        letterSpacing: 0.0,
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(50.0),
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1525069011944-e7adfe78b280?w=512&h=512',
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(50.0),
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1525357816819-392d2380d821?w=512&h=512',
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
